...
//  Modified by Callen Egan on 1/18/21
//
...
class FaceLivenessCameraController : UIViewController, AcuantHGLiveFaceCaptureDelegate{
    ...
    //returns instance of this class with delegate assigned
    public class func getFaceLivenessCameraController( delegate:AcuantHGLivenessDelegate )->FaceLivenessCameraController
    {
        let classRef = FaceLivenessCameraController()
        classRef.delegate = delegate
        return classRef
    }
